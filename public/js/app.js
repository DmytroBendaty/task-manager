...
document.addEventListener('livewire:load', function () {
  ...
  sortablejs__WEBPACK_IMPORTED_MODULE_2__["default"].create(list, {
    animation: 150,
    handle: '[wire\\:sortable\\.handle]',
    onEnd: function onEnd(evt) {
      var orderedIds = Array.from(list.children).map(function (child) {
        return child.getAttribute('wire:sortable.item');
      });
      livewire_sortable__WEBPACK_IMPORTED_MODULE_3__["Livewire"].emit('updateTaskOrder', orderedIds);
    }
  });
});
...
__webpack_require__(/*! C:\xampp\htdocs\task_manager\task-manager\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\task_manager\task-manager\resources\css\app.css */"./resources/css/app.css");
